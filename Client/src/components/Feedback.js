...
const Feedback = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const feedbackData = {
            ...
            DoctorID: id,
            Feedback: feedback,
            Vote: (willRecommend===true?1:0),
            DrName: doctorName,
            Patient:PatientName

        }
        console.log((willRecommend===true?1:0));
    ...
    <div className='container mt-5'>
        <form onSubmit={handleSubmit}>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value={PatientName} onChange={e => setPatientName(e.target.value)} />
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Doctor Name</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value={doctorName} onChange={e => setDoctorName(e.target.value)}/>
            </div>
            <div class="mb-3">
